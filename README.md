...
- **[confer](https://github.com/samzong/confer)**: Local multi-agent rooms over MCP for coding agents. [release](https://github.com/samzong/confer/releases/latest) [stars](https://github.com/samzong/confer/stargazers)
- **[combe](https://github.com/samzong/combe)**: A worktree-aware terminal for Macs — built for my own agent workflow. [stars](https://github.com/samzong/combe/stargazers)
...
- **[Runes](https://github.com/samzong/Runes)**: Deterministic personal identity system — one mark for every project and platform. [stars](https://github.com/samzong/Runes/stargazers)
