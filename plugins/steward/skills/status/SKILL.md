---
name: status
description: Show the current Steward case status without writing files. Use when the user asks where a Steward review stands, wants the current verdict, or asks for steward status.
---
