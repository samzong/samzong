---
name: feasibility
description: Decide whether a task should be fixed and whether the proposed approach is acceptable. Use when the user asks for steward feasibility or wants a first maintainer decision.
---
