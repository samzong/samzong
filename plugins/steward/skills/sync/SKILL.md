---
name: sync
description: Refresh the current Steward case file without changing status. Use before handoff, tool switching, restart, or when the user asks for steward sync.
---
