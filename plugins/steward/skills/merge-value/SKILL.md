---
name: merge-value
description: Decide whether a change is worth merging after source-backed review. Use when the user asks for steward merge-value or wants a maintainer merge-worthiness verdict.
---

# Merge Value

Use this skill for the Steward merge-value decision.
